...
Recomiendo repasar fuertemente los contenidos de física del CBC y tener todos los temas frescos. Con respecto a la matemática, recomiendo tener muy bien aceitados los temas de análisis 2 (más que nada para lo que es electroestática en adelante) con respecto a los operadores diferenciales de campos vectoriales y los teoremas integrales (entender bien la geometría detrás de todo esto es fundamental). Para la primera parte de la materia recomiendo repasar álgebra vectorial y trigonometría. Finalmente recomiendo tener bien aceitado el manejo de sistemas de ecuaciones diferenciales lineales para las últimas unidades de la materia.
